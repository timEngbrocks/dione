...
use crate::{
    class_loader::{
        class_file::{compare_class_file_version_to_global, ClassFile},
        constant_pool_info::{
            constant_method_handle_info::ConstantMethodHandleKind, ConstantPoolInfoType,
        },
    },
    resolve_constant,
};
...
use super::{
    ...
    sym_ref_method_of_interface::SymRefMethodOfInterface, RuntimeConstant,
};
...
impl RuntimeConstant for SymRefMethodHandle {
    fn resolve(index: u16, class_file: &ClassFile) -> Self {
        ...
        match kind {
            ...
            ConstantMethodHandleKind::InvokeStatic | ConstantMethodHandleKind::InvokeSpecial => {
...
fn is_allowed_method_name(name: &str, kind: ConstantMethodHandleKind) -> bool {
    match kind {
        ...
        | ConstantMethodHandleKind::InvokeInterface => name != "<init>" && name != "<clinit>",
        ConstantMethodHandleKind::NewInvokeSpecial => name == "<init>",
        _ => true,
    }
}
