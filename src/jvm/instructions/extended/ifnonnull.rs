use crate::{jvm::{frame::Frame, instructions::{Instruction, InstructionResult, BranchKind}, types::Types}, class_loader::parser::{Parser, U2, U1}, opcodes};
...
impl Instruction for IFNONNULL {
	...
	fn to_string(&self) -> String {
		format!("ifnonnull {}", (self.branchbyte1 as i16) << 8 | self.branchbyte2 as i16)
	}
}