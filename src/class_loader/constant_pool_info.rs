...
use self::{
    constant_class_info::ConstantClassInfo, constant_double_info::ConstantDoubleInfo,
    constant_dynamic_info::ConstantDynamicInfo, constant_fieldref_info::ConstantFieldrefInfo,
    constant_float_info::ConstantFloatInfo, constant_integer_info::ConstantIntegerInfo,
    constant_interface_methodref_info::ConstantInterfaceMethodrefInfo,
    constant_invoke_dynamic_info::ConstantInvokeDynamicInfo, constant_long_info::ConstantLongInfo,
    constant_method_handle_info::ConstantMethodHandleInfo,
    constant_method_type_info::ConstantMethodTypeInfo,
    constant_methodref_info::ConstantMethodrefInfo, constant_module_info::ConstantModuleInfo,
    constant_name_and_type_info::ConstantNameAndTypeInfo,
    constant_package_info::ConstantPackageInfo, constant_string_info::ConstantStringInfo,
    constant_utf8_info::ConstantUtf8Info,
};

use super::parser::{Parser, U1, U2};
...
impl ConstantPoolInfo for ConstantPoolInfoType {
    fn new(parser: &mut Parser) -> Self {
        ...
        match tag {
            ...
            11 => ConstantPoolInfoType::InterfaceMethodref(ConstantInterfaceMethodrefInfo::new(
                parser,
            )),
...
impl fmt::Debug for ConstantPool {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let tags: Vec<u8> = self
            .constants
            .iter()
            .map::<u8, _>(|constant| *constant.get_tag())
            .collect();
        write!(
            f,
            "Constants: [{}]",
            itertools::join(&mut tags.iter(), ", ")
        )
    }
}
