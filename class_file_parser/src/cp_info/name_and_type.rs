...
impl fmt::Display for NameAndType {
	fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Tag: {}, Name Index: {}, Descriptor Index: {}", self.tag, self.name_index, self.descriptor_index)?;
        Ok(())
    }
}

pub fn nameandtype_parser<'a, E: ParseError<&'a[u8]> + std::fmt::Debug>(input: &'a[u8]) -> IResult<&'a[u8], NameAndType> {
